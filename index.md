...
## Gathering Data
I pulled the data used in my project from the IMDb datasets and also scraped from the IMDb page for each specified movie and from the user reviews page of the specified movie.
